...
areas = {
        ...
        'xian.kmz': [34021652,108599166,34533432,109295425],
        'jinan.kmz': [36576248,116886119,36755939,117221546],
        'hainan.kmz': [18107610,108519172,20183202,111106452],
        'changsha.kmz': [27653729,112770538,28394420,113308868],
        'nanning.kmz': [22634509,108099975,22994011,108553161],
        'kunming.kmz': [24892000,102560462,25173210,102880439],
        'changchun.kmz': [43655045,124992538,44118244,125681930],
        'shantou.kmz': [23004156,116253890,23677475,117042160],
        'langfang.kmz': [39435531,116559791,39635704,116833076],
        'xuzhou.kmz': [33915973,116667289,34660282,117672538],
        'deyang.kmz': [31023178,104053573,31220684,104514312],
        'maoming.kmz': [21605943,110766563,21950267,111039848],
        'xiamen.kmz': [24342931,117539978,24689037,118671569],
        }
styles = {
        ...
        'ALIENS_0_1': 'http://s.binux.me/ingress/icon/enlightened_3/1.png',
        'ALIENS_1_1': 'http://s.binux.me/ingress/icon/enlightened_3/1.png',
        'ALIENS_2_1': 'http://s.binux.me/ingress/icon/enlightened_3/2.png',
        'ALIENS_3_1': 'http://s.binux.me/ingress/icon/enlightened_3/3.png',
        'ALIENS_4_1': 'http://s.binux.me/ingress/icon/enlightened_3/4.png',
        'ALIENS_5_1': 'http://s.binux.me/ingress/icon/enlightened_3/5.png',
        'ALIENS_6_1': 'http://s.binux.me/ingress/icon/enlightened_3/6.png',
        'ALIENS_7_1': 'http://s.binux.me/ingress/icon/enlightened_3/7.png',
        'ALIENS_8_1': 'http://s.binux.me/ingress/icon/enlightened_3/8.png',
        ...
        'RESISTANCE_0_1': 'http://s.binux.me/ingress/icon/resistance_3/1.png',
        'RESISTANCE_1_1': 'http://s.binux.me/ingress/icon/resistance_3/1.png',
        'RESISTANCE_2_1': 'http://s.binux.me/ingress/icon/resistance_3/2.png',
        'RESISTANCE_3_1': 'http://s.binux.me/ingress/icon/resistance_3/3.png',
        'RESISTANCE_4_1': 'http://s.binux.me/ingress/icon/resistance_3/4.png',
        'RESISTANCE_5_1': 'http://s.binux.me/ingress/icon/resistance_3/5.png',
        'RESISTANCE_6_1': 'http://s.binux.me/ingress/icon/resistance_3/6.png',
        'RESISTANCE_7_1': 'http://s.binux.me/ingress/icon/resistance_3/7.png',
        'RESISTANCE_8_1': 'http://s.binux.me/ingress/icon/resistance_3/8.png',
